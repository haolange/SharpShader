# SharpShader contributor instructions
...
Compiler core must not reference SharpGPU. Keep GPU integration in SharpShader.SharpGPU, generators as build-time assets, and resource identity independent of checkout paths.
